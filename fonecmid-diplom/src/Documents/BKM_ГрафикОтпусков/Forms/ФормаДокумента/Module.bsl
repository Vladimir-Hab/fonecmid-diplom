...
Процедура Заполнить(Команда)
	ЗаполнитьСписокАсинх();
КонецПроцедуры

&НаКлиенте
Асинх Процедура ЗаполнитьСписокАсинх() 
...
Процедура ПрименитьУсловноеОформление()   
	...
	ЭлементОтбора.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Объект.ОтпускаСотрудников.ВсегоДней");
	...
	ПолеОформления.Поле = Новый ПолеКомпоновкиДанных("ОтпускаСотрудниковВсегоДней");
