...
//	
//	РеквизитыДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Договор, "ВидДоговора, BKM_ДатаНачала, BKM_ДатаОкончания");
//	
...
//		Если РеквизитыДоговора.BKM_ДатаНачала > Дата Или РеквизитыДоговора.BKM_ДатаОкончания < Дата Тогда
//			
...
//		ИзмененныеРеквизиты.Вставить("ВремяНачалаПлан", ВремяНачалаПлан);
//		ИзмененныеРеквизиты.Вставить("ВремяОкончанияПлан", ВремяОкончанияПлан);
...
//						Формат(ВремяНачалаПлан,"ДФ=ЧЧ.мм"),Формат(ВремяОкончанияПлан,"ДФ=ЧЧ.мм"), Специалист);
//		
//	КонецЕсли;
//	
